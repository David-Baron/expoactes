...
/**
 * transforme une date républicaine en date grégorienne
 */
function convert_dt_repub($rj, $rm, $ra)
{
...
/**
 * formate une date républicaine longue en courte
 */
function formate_dt_repub($rj, $rm, $ra)
{
