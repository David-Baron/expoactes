<?php
/**
 * @Deprecated Will use password_hash and password_verify instead
 */
...
define('EA_URL_SITE', mkSiteUrl());  // ASSURER QUE "loginutils.php" est toujours référencé après "adlcutils.php"
...
function logonok($level = 0)
{
	...
	if (!defined("EA_MAINTENANCE")) define("EA_MAINTENANCE", 0); // TODO Why this is tested here????
	// Autentification PHP
...
/**
 * Uniquement utilisé par authentification
 */
function login($path)
{
	global $root;
