...
if ($old_param) {
	...
	echo "ATTENTION : Le fichier _config/connect.inc.php contient encore des paramètres !<br />";
	echo "Vous DEVEZ les supprimer, sinon, les modifications faites ici seront sans effet.";
	echo '</b></font></p>';
}
