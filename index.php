...
if (!file_exists("_config/connect.inc.php")) {
	echo '<p class="erreur">Lancer le script d\'installation pour avoir accés à l\'application<br />';
	echo 'Pour des raisons de sécurité il n\'a pas été fait de lien direct.<br /></p>';
	exit;
}
...
if (!check_version(EA_VERSION, '3.2.2')) { // si version mémorisée < 3.2.2
	...
	echo '<p class="erreur">La montée de version d\'ExpoActes n\'est possible que depuis la version 3.2.2.<br /></p>';
